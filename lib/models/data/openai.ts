...
const openaiModels: ModelConfig[] = [
  ...
  },
  {
    ...
    baseProviderId: 'openai',
    description:
      'Advanced GPT-5 model with maximum capabilities and file search',
    ...
    apiSdk: (apiKey, settings) =>
      openproviders(
        'gpt-5-pro',
        settings as OpenProvidersOptions<'gpt-5-pro'>,
        apiKey
      ),
  },
  {
  ...
  },
  {
    ...
    apiSdk: (apiKey, settings) =>
      openproviders(
        'gpt-5-thinking',
        settings as OpenProvidersOptions<'gpt-5-thinking'>,
        apiKey
      ),
  },
  {
    ...
    apiSdk: (apiKey, settings) =>
      openproviders(
        'gpt-5-thinking-mini',
        settings as OpenProvidersOptions<'gpt-5-thinking-mini'>,
        apiKey
      ),
  },
  {
    ...
    apiSdk: (apiKey, settings) =>
      openproviders(
        'gpt-5-thinking-nano',
        settings as OpenProvidersOptions<'gpt-5-thinking-nano'>,
        apiKey
      ),
  },
  {
    ...
    apiSdk: (apiKey, settings) =>
      openproviders(
        'gpt-5-chat-latest',
        settings as OpenProvidersOptions<'gpt-5-chat-latest'>,
        apiKey
      ),
  },
];
