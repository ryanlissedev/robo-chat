...
const API_PROVIDERS = [
  ...
  },
  {
    ...
    name: 'Groq',
    required: false,
    description: 'For ultra-fast Llama and Mixtral models',
  },
  {
    id: 'openrouter',
    name: 'OpenRouter',
    required: false,
    description: 'For DeepSeek and other models',
  },
  {
    id: 'langsmith',
    name: 'LangSmith',
      ...
      const { error } = await supabase.from('user_keys').upsert(
        {
          user_id: userId,
          provider,
          encrypted_key: key, // This should be encrypted in production
          iv: 'placeholder_iv', // Should be actual IV in production
