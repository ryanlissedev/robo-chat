    ...
    <div className="relative mr-2 mb-0 flex items-center">
      ...
      >
        <HoverCardTrigger className="w-full">
          <div className="flex w-full items-center gap-3 rounded-2xl border border-input bg-background p-2 pr-3 transition-colors hover:bg-accent" data-testid="uploaded-file" data-filename={file.name}>
