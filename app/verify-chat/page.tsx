...
export default function VerifyChat() {
  ...
  return (
    <div className="p-4 max-w-4xl mx-auto">
      <h1 className="text-2xl mb-4 font-bold">✅ Chat Verification - AI SDK v5</h1>
      
      <div className="mb-4 bg-green-50 border border-green-200 p-3 rounded">
        <p className="text-green-800">
          <strong>Test Status:</strong> <span className="font-mono">{status}</span> | 
      ...
      <div className="border-t pt-4">
        ...
        <div className="mt-2 text-sm text-gray-600">
          <strong>Expected behavior:</strong> Reasoning should appear in yellow box, followed by main response text.
        </div>
      </div>
    </div>
  );
