# Images for FAQ Data collection.pdf
...
pdftoppm -png -r 200 "path/to/FAQ Data collection.pdf" images/page
```

### Option 2: Online Conversion
1. Upload FAQ Data collection.pdf to an online PDF to PNG converter
...
1. Open FAQ Data collection.pdf in a PDF viewer
