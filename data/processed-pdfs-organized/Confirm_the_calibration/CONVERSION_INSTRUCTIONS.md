# PDF Processing Instructions: Confirm the calibration.pdf
...
pdftoppm -png -r 200 "/Users/neo/Developer/HGG/experiments/RRA_V2/data/pdf/Confirm the calibration.pdf" images/page
...
convert -density 200 -quality 95 "/Users/neo/Developer/HGG/experiments/RRA_V2/data/pdf/Confirm the calibration.pdf" images/page-%03d.png
```
...
images = convert_from_path('/Users/neo/Developer/HGG/experiments/RRA_V2/data/pdf/Confirm the calibration.pdf', dpi=200)
...
## File Locations
- **Original PDF**: `/Users/neo/Developer/HGG/experiments/RRA_V2/data/pdf/Confirm the calibration.pdf`
- **Extracted Text**: `data/extracted-text.json` and `data/extracted-text.md`
- **Images Directory**: `images/` (currently empty)
- **Metadata**: `metadata/` directory

---
*Generated by PDF Output Organizer on 2025-06-08T09:59:05.797Z*
