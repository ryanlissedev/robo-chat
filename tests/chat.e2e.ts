...
test.describe('RoboRail Assistant Chat Interface', () => {
  ...
  test.describe('Basic Chat Functionality', () => {
    test('should load chat interface correctly', async () => {
      await expect(chatPage.pageInstance.locator('[data-testid="chat-container"]')).toBeVisible();
      await expect(chatPage.pageInstance.locator('[data-testid="message-input"]')).toBeVisible();
      await expect(chatPage.pageInstance.locator('[data-testid="send-button"]')).toBeVisible();
    });
  ...
  test.describe('Theme System', () => {
    test('should switch between themes', async () => {
      ...
      const htmlClass = await chatPage.pageInstance.locator('html').getAttribute('class');
      ...
      const htmlClass2 = await chatPage.pageInstance.locator('html').getAttribute('class');
