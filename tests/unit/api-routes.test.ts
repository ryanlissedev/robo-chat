...
import { POST as favoriteModelsPost, GET as favoriteModelsGet } from '@/app/api/user-preferences/favorite-models/route'
  ...
  describe('/api/feedback', () => {
    describe('POST', () => {
      ...
      it('should handle LangSmith failure gracefully', async () => {
        ...
        vi.mocked(validateUserIdentity).mockResolvedValue(mockSupabase as any)
        vi.mocked(createFeedback).mockRejectedValue(new Error('LangSmith error'))
